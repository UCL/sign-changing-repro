...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
	...
	table[x=h,y= Galerkin-inner] {../data/MetaMaterial-k1-stab_mmPML0.dat};   
    \addplot[cyan,ultra thick,mark=x,mark options={scale=0.35}]  
	table[x=h,y=Hybridstab-inner] {../data/MetaMaterial-k1-stab_mmPML0.dat};  
    \addplot[magenta,only marks,mark=x,mark options={scale=1.2}]  
	table[x=h,y= Galerkin-outer] {../data/MetaMaterial-k1-stab_mmPML0.dat};   
    \addplot[magenta,only marks,mark=o,mark options={scale=1}]  
	table[x=h,y=Hybridstab-outer] {../data/MetaMaterial-k1-stab_mmPML0.dat};  
    \addplot[lightgray,dashed,ultra thick]
	table[mark=none,x=h,y expr ={3*\thisrowno{0}}] {../data/MetaMaterial-k1-stab_mmPML0.dat};  
	...
	table[x=h,y= Galerkin-inner] {../data/MetaMaterial-k2-stab_mmPML0.dat};   
    \addplot[ cyan,ultra thick,mark=x,mark options={scale=0.35} ,forget plot]  
	table[x=h,y=Hybridstab-inner] {../data/MetaMaterial-k2-stab_mmPML0.dat};  
    \addplot[ magenta,only marks,mark=x,mark options={scale=1.2}  ,forget plot]  
	table[x=h,y= Galerkin-outer] {../data/MetaMaterial-k2-stab_mmPML0.dat};   
    \addplot[ magenta,only marks,mark=o,mark options={scale=1}  ,forget plot]  
	table[x=h,y=Hybridstab-outer] {../data/MetaMaterial-k2-stab_mmPML0.dat};  
    \addplot[lightgray,dotted,ultra thick] 
	table[mark=none,x=h,y expr ={3*\thisrowno{0}}] {../data/MetaMaterial-k2-stab_mmPML0.dat};  
    \addplot[lightgray,dashed,ultra thick] 
	table[mark=none,x=h,y expr ={3*\thisrowno{0}*\thisrowno{0}}] {../data/MetaMaterial-k2-stab_mmPML0.dat};  
    \legend{ $\mathcal{O}(h) $, $\mathcal{O}(h^2) $ } 
    ...
    \addplot[ cyan,ultra thick,dashed,mark=x,mark options={scale=0.35}  ,forget plot]  
	table[x=h,y= Galerkin-inner] {../data/MetaMaterial-k3-stab_mmPML0.dat};   
    \addplot[cyan,ultra thick,mark=x,mark options={scale=0.35}  ,forget plot]  
	table[x=h,y=Hybridstab-inner] {../data/MetaMaterial-k3-stab_mmPML0.dat};  
    \addplot[magenta,only marks,mark=x,mark options={scale=1.2}   ,forget plot]  
	table[x=h,y= Galerkin-outer] {../data/MetaMaterial-k3-stab_mmPML0.dat};   
    \addplot[magenta,only marks,mark=o,mark options={scale=1}   ,forget plot]  
	table[x=h,y=Hybridstab-outer] {../data/MetaMaterial-k3-stab_mmPML0.dat};  
    \addplot[lightgray,dashed,ultra thick] 
	table[mark=none,x=h,y expr ={1.3*\thisrowno{0}*\thisrowno{0}*\thisrowno{0}  }] {../data/MetaMaterial-k3-stab_mmPML0.dat};  
